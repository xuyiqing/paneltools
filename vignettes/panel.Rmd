...
```{r hh_stplot2, message = FALSE, warning = FALSE, fig.width = 7, fig.height = 5, cache=TRUE}
...
```{r hh_saplot2, message = FALSE, warning = FALSE, fig.width = 7, fig.height = 5, cache=TRUE}
...
```{r hh_csplot2a, message = FALSE, warning = FALSE, fig.width = 7, fig.height = 5, cache=TRUE}
...
```{r hh_pm3, message = FALSE, warning = FALSE, fig.width = 7, fig.height = 5, cache=TRUE}
...
```{r hh_balance2, message = FALSE, warning = FALSE, fig.width = 7, fig.height = 5, cache=TRUE}
...
```{r,hh_honest.placebo.honest.gap.p, warning=FALSE,  fig.width = 7, fig.height = 5}
...
```{r gb_twfeplot2, message = FALSE, warning = FALSE, fig.width = 7, fig.height = 5, cache=TRUE}
twfe.output <- as.data.frame(twfe.output)
...
```{r gb_pm3, message = FALSE, warning = FALSE, fig.width = 7, fig.height = 5, cache=TRUE}
est_lead <- as.vector(PE.results$estimates)
est_lag <- as.vector(PE.results.placebo$estimates)
sd_lead <- apply(PE.results$bootstrapped.estimates,2,sd)
sd_lag <- apply(PE.results.placebo$bootstrapped.estimates,2,sd)
...
```{r gb_fectplot2, message = FALSE, warning = FALSE, fig.width = 7, fig.height = 5, cache=TRUE}
fect.output <- as.data.frame(fect.output)
...
```{r gb_balance2, message = FALSE, warning = FALSE, fig.width = 7, fig.height = 5, cache=TRUE}
fect.balance.output <- as.data.frame(out.fect.balance$est.balance.att)
